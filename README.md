...
Freehold divides the map into square **cells** (24 tiles by default; 16 and 32 available via startup setting) and puts each one on a four-state ladder. Land stops being binary — you don't own a chunk or not, you hold a particular *right* over it, and you buy your way up.
