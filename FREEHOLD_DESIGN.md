...
|---|---|---|---|---|---|
| `fh-cell-size` | startup | string | 24 | {16, 24, 32} | Cell edge length in tiles; changing on an existing save releases all claims with a full refund (ADR-0010) |
